            ...
            <div class="col">
              <div class="card card-primary card-outline">
                ...
                <div class="form-group">
                    <label >Nama</label>
                    <input type="text" class="form-control" placeholder="masukkan nama gambar" name="nama" id="nama" value="{{ $dt->nama}}">
                    <label >Gambar</label><br>
                    <input type="file" name="gambar" id="gambar">
                    <div class="form-group" style="margin:20px 20px 20px 0px;">
                        <img src="{{ asset('img/'. $dt->gambar) }}" height="100px" width="100px" alt="" srcset="">
                    </div>
                </div>
            </div>
